...
describe('formatPrice for positive numbers', () => {
    ...
    test('formatPrice shold format number pt-BR when given 0.1', () => {
...
describe('formatPrice for non positive numbers', () => {
    test('formatPrice shold format number pt-BR when given 0', () => {
        const result = formatPrice(0);
        expect(result).toEqual("0,00");
    });


    test('formatPrice shold format number pt-BR when given -5.1', () => {
